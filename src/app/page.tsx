import { FunctionDescriptionCards } from "@/components/ui/FunctionDescriptionCards";
...
export default function Home() {
  return (
    <div className="flex flex-col">
      ...
      {/* Features Section */}
      <div className="flex items-center justify-center flex-col h-auto px-4 py-6 space-y-6">
        <div>
